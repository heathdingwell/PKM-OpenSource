...
- Quick search result actions:
  ...
  - `Set as template` for selected result (button)
  - `Add to shortcuts` for selected result (button)
  - `Pin to Home` for selected result (button)
  - `Pin to notebook` for selected result (button)
  - `Export as Markdown` for selected result (button)
  - `Export as HTML` for selected result (button)
  - `Export as Text` for selected result (button)
  - `Export as PDF` for selected result (button)
  - `Print` selected result (button)
